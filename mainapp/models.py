...
class Product(models.Model):
    ...
    # pola dla sprawdzania rozmiarow zdjecia
    ...
    def get_model_name(self):
        ...
        # Sprawdzanie rozmiaru i w razie potrzeby przycinanie obrazu, aby zmniejszyć przestrzeń zajmowaną przez zdjęcia
        ...
        #     raise MinResolutionErrorException('Your image resolution is less than the minimum!')
        # if img.height > max_height or img.width > max_width:
        #     raise MaxResolutionErrorException('Your image resolution is more than the maximum!')
        # image = self.image
        # img = Image.open(image)
...
class Smartphone(Product):
    ...
    sd_volume_max = models.CharField(max_length=255, null=True, blank=True, verbose_name='Maximum Embedded Memory')
    ...
    # @property
    # @property ułatwia tworzenie właściwości w klasach Pythona. Właściwości wyglądają jak zwykłe atrybuty (pola) klasy,
    # ale kiedy są odczytywane, wywoływany jest moduł getter,
    # a po zapisaniu wywoływany jest setter. Czyli pozwoli zamienić metodę klasy w atrybut klasy.
    # def sd(self):
    #     if self.sd:
    #         return 'Yes'
    #     return 'No'
...
class CartProduct(models.Model):
    ...
    # ta metoda została stworzona, aby poprawnie obliczyć łączną kwotę i nie wyświetlać
    # w koszyku dwóch identycznych produktów, ale z różnymi cenami
    def save(self, *args, **kwargs):
...
class Customer(models.Model):
    ...
    phone = models.CharField(max_length=28, verbose_name='Phone number', null=True, blank=True)
