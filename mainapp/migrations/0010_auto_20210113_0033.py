...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mainapp', '0009_auto_20210112_1845'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('buying_type', models.CharField(choices=[('self', 'Pickup'), ('delivery', 'Delivery')], default='self', max_length=100, verbose_name='Type of order')),
        ...
        migrations.AddField(
            model_name='customer',
            name='orders',
            field=models.ManyToManyField(related_name='related_customer', to='mainapp.Order', verbose_name='Buyer orders'),
        ),
    ]
